 ...
 * 
 */
public class CTC_JEX_MakeCalibrationImageFromObject extends JEXCrunchable {
	...
	public ParameterSet requiredParameters()
	{
		...
		Parameter p3 = new Parameter("Final Smoothing Method", "Smoothing function to apply at the end", Parameter.DROPDOWN, new String[] { "none", CTC_JEX_StackProjection.METHOD_MEAN, CTC_JEX_StackProjection.METHOD_MEDIAN }, 2);
